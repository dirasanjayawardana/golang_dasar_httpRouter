...
// Untuk ServeFile (memberikan response file static) dengan menggunakan Router, bisa menggunakan router.ServFiles(Path, FileSystem)
// pada Path harus menggunakan CatchAllParameter
// pada FileSystem bisa melakukan load dari folder atau menggunakan golang embed
